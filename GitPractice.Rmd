...
vector3<- filter(heroes, Publisher == "Marvel Comics"| Publisher == "DC Comics")
...
hero_and_power<- data.frame(powers_sum$hero_names,powers_sum$num_powers)
...
hero1<- select(heroes, name, Publisher)
power1<- select(powers, hero_names, num_powers)
